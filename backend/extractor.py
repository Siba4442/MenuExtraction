...
# Phase 2
# ----------------------------
async def run_phase2(restaurant_name: str, categories_payload: Dict[str, Any], pdf_path: str) -> Dict[str, Any]:
    # CHANGE: Replaced hardcoded PDF_PATH with the dynamic pdf_path argument
    images = await convert_pdf_into_images(pdf_path)
...
async def run_phase3(restaurant_name: str, category_bases_payload: Dict[str, Any], pdf_path: str) -> Dict[str, Any]:
    # CHANGE: Replaced hardcoded PDF_PATH with the dynamic pdf_path from your API
    images = await convert_pdf_into_images(pdf_path)
...
async def run_phase4(restaurant_name: str, category_payload: Dict[str, Any], category_base_payload: Dict[str, Any], pdf_path: str) -> Dict[str, Any]:
    # CHANGE: Replaced hardcoded PDF_PATH with the dynamic pdf_path from your API
    images = await convert_pdf_into_images(pdf_path)
...
async def main():
    ...
    if phase == 1:
        result = await run_phase1(restaurant_name,PDF_PATH)
        ...
        result = await run_phase2(restaurant_name, categories_payload,PDF_PATH)
